...
This project is a chat bot implemented
...
in natural language conversations with the GPT-3.5 model.
...
1.  Clone the repository:
    ...
    ```bash
    git clone https://github.com/Yashwanth023/SimpleChatbot_using_mern.git
    ```
